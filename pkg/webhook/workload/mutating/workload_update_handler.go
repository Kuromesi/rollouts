...
func (h *WorkloadHandler) fetchMatchedRollout(obj client.Object) (*appsv1alpha1.Rollout, error) {
	...
	for i := range rolloutList.Items {
		...
		if !rollout.DeletionTimestamp.IsZero() || rollout.Spec.ObjectRef.WorkloadRef == nil || rollout.Status.Phase == appsv1alpha1.RolloutPhaseDisabled || rollout.Status.Phase == appsv1alpha1.RolloutPhaseConflict {
			continue
		}
